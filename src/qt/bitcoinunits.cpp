...
QString BitcoinUnits::name(int unit)
{
    switch(unit)
    {
    case BTC: return QString("XJM");
    case mBTC: return QString("mXJM");
    case uBTC: return QString::fromUtf8("μXJM");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString(QObject::tr("Monetas"));
    case mBTC: return QString(QObject::tr("Milli-Monetas (1 / 1,000)"));
    case uBTC: return QString(QObject::tr("Micro-Monetas (1 / 1,000,000)"));
    default: return QString("???");
    }
}
